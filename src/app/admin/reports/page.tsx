        ...
        <div style={{ borderBottom: '1px solid var(--border)', background: 'linear-gradient(135deg, var(--brand-navy) 0%, #1e3a8a 100%)', flexShrink: 0 }}>
          <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '1.25rem 2rem', display: 'flex', alignItems: 'center', gap: '1rem', width: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
              ...
              <div style={{ backgroundColor: 'rgba(255,255,255,0.08)', padding: '2px 14px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center' }}>
                <img src="/kadellabs-logo.png" alt="Kadel Labs Logo" style={{ height: '60px', objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
              </div>
