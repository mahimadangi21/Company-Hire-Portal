...
export function StructuredAnalysisView({ text }: { text: string | any }) {
  ...
  // If there are no structured points, just render text nicely
  if (!pros.length && !cons.length && !okok.length) {
    return (
